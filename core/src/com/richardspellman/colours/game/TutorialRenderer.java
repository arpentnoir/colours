 ...
 */
public class TutorialRenderer implements Disposable{
    ...
    public TutorialRenderer(TutorialController tutorialController){
    ...
    public void renderTutorial(SpriteBatch batch){
      //worldController.cameraHelper.applyTo(camera);
      batch.setProjectionMatrix(camera.combined);
      batch.begin();
      tutorialController.tutorial.render(batch);
      batch.end();
