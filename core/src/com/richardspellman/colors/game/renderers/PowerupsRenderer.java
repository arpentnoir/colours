...
import com.richardspellman.colors.game.controllers.PowerupController;
...
public class PowerupsRenderer implements Disposable {
  ...
  private void init(){
    ...
    layout.setText(Assets.instance.fonts.defaultBig, "Powerups");
  ...
  public void renderPowerups(SpriteBatch batch){
    ...
    batch.begin();
    Assets.instance.fonts.defaultBig.draw(batch, "Powerups", (int) (Constants.VIEWPORT_GUI_WIDTH / 2 - stringWidth / 2), 50);
    batch.end();
